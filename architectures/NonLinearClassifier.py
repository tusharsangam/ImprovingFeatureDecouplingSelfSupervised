...
class Classifier(nn.Module):
    def __init__(self, nChannels=256, num_classes=200, cls_type='Alexnet_conv5'):
        ...
        if self.cls_type == 'Alexnet_conv5' or self.cls_type == 'Alexnet_conv4':
            ...
            self.classifier.add_module('Linear1', nn.Linear(nChannels*6*6, 4096, bias=False))
